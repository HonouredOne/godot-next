...
Godot Node Extensions, AKA Godot NExt, is a Godot 3.1+ (the current version partially supports 4.5.x) repository dedicated to collecting basic script classes that are currently unavailable in vanilla Godot.
